...
* **이클립스 자바 프로젝트 만들기**
    ...
    - 프로젝트 이름 Test로 작성 (첫글자 대문자로 작성)
    - src폴더 우클릭, New - Package 선택
    - simple 입력, Finish (첫글자 소문자)
    - simple 패키지 우클릭, New - Class 선택
    - Hello 입력, Finish (첫글자 대문자)
...
* **자바의 기본 데이터타입**
    ...
    - 정수형 타입 (소수점 이하를 표현하지 않는 숫자 형식)   
	    ...
	    3 <u> **int** </u> (4Bytes) 약 -21억 ~ 약 21억 => **(정수형 기본 데이터타입)**   
	    4 long (8Bytes)	약 -900경 ~ 약 900경
    - 실수형 타입 (소수점 이하를 표현하는 숫자 형식)   
        5 float (4Bytes)   
	    6 <u> **double** </u> (8Bytes) => **(실수형 기본 데이터타입)**
    - 논리형 타입   
	    7 <u> **boolean** </u> (1Byte) true/false => **(논리형 기본 데이터타입)**   
    (true:참, false:거짓)
    - 문자형 타입   
	    8 <u> **char** </u> (2Bytes) => **(문자형 기본 데이터타입)**   
